...
test("only the Sessions new-session dropdown updates the persisted profile preference", () => {
	...
	assert.equal(appSource.match(/onNewSessionProfileChange=\{setPreferredNewSessionProfile\}/g)?.length, 1, "the shared responsive Sessions sidebar owns the only preference mutation");
