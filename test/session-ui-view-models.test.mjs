...
test("Web Compact Terminal source preserves shared flow ordering hooks and streaming semantics", () => {
	...
	assert.match(compactSource, /buildCompactTerminalRows\(traceView, \{ showThinking, hideTools \}\)/, "Web terminal must derive rows from shared row builder with display filters");
