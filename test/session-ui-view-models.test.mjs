...
test("Web Compact Terminal source preserves shared flow ordering hooks and streaming semantics", () => {
	...
	assert.match(compactSource, /const effectiveToolDisplayMode = targetToolCallNodeId \? "full" : toolDisplayMode/, "Tool-call deep links should reveal targets hidden by compact display modes");
