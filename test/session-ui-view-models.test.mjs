...
test("Web Compact Terminal source preserves shared flow ordering hooks and streaming semantics", () => {
	...
	assert.match(compactSource, /buildCompactTerminalRows\(traceView, \{ showThinking, toolDisplayMode: effectiveToolDisplayMode, debugMode \}\)/, "Web terminal must derive rows, tool display mode, and debug mode from the shared row builder");
