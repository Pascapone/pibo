...
test("OpenAI transcription provider sends official multipart transcription requests", async () => {
	let captured;
...
test("OpenAI transcription provider reports missing API authentication without sending audio", async () => {
	let requested = false;
	const provider = createOpenAiTranscriptionProvider({
