...
- Candidate next runtime seams in `runtime/index.ts`: one-node workflow completion/failure helpers, Pibo session routing helpers, or other pure bottom-of-file helpers. Prefer analysis or tests before extracting central dispatch orchestration.
