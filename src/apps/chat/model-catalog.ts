...
type ModelRegistryExtensionHook = (registry: MiniMaxModelRegistryLike & GlmModelRegistryLike & OpenAiGpt56ModelRegistryLike & QwenTokenPlanModelRegistryLike) => void;
...
export async function loadModelCatalogWithServices(
	...
	try {
		...
		extensionHook?.(services.modelRegistry as unknown as MiniMaxModelRegistryLike & GlmModelRegistryLike & OpenAiGpt56ModelRegistryLike & QwenTokenPlanModelRegistryLike);
