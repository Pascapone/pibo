	...
	return (
		<div data-pibo-component="TerminalCompactionCard" className="min-w-0">
			<div className="grid grid-cols-[1.9rem_minmax(0,1fr)] gap-2 whitespace-pre-wrap break-words">
				<span className="flex items-center text-[#22c55e]"><Minimize2 size={13} aria-hidden="true" /></span>
				<span className="font-semibold text-[#22c55e]">Compacted</span>
			</div>
			<div
				className="ml-[1.9rem] mt-2 grid gap-px border-y border-[#262626] bg-[#050505] sm:grid-cols-3"
			...
			<details
				className="ml-[1.9rem] mt-2 border border-[#2a2a2a] bg-[#111111]"
				onToggle={(event) => {
