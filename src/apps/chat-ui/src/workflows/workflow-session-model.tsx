import type { PiboSession, PiboWebSessionNode, PiboWorkflowSession } from "../types";
...
export function createWorkflowHeaderSummary(link: PiboWorkflowSession): WorkflowHeaderSummary {
  return { workflowId: link.workflowId, state: workflowStateLabel(link), ...(link.workflowRunId ? { workflowRunId: link.workflowRunId } : {}) };
}
...
export function workflowStateLabel(link: PiboWorkflowSession): string { return link.state.replace(/_/g, " "); }
