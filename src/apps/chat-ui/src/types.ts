...
export type PiboLoopRun = { id: string; jobId: string; piboSessionId?: string; status: "running" | "ok" | "error" | "cancelled"; reason?: string; error?: string; startedAt?: string; completedAt?: string; accounting?: { tokenBudget?: number; tokenReserve?: number; tokensUsedBefore?: number; remainingTokensBefore?: number; tokensUsed?: number; overshootTokens?: number; activeTimeSeconds?: number }; createdAt: string; updatedAt: string };
