...
const requiredColumns: Record<(typeof WORKFLOW_SQLITE_TABLES)[number], string[]> = {
  ...
  workflow_migration_receipts: ["migration_id", "source_digest", "source_path", "archive_path", "completed_at"],
  workflow_session_links: ["pibo_session_id", "workflow_id", "workflow_version", "workflow_run_id", "state", "configuration_json", "created_at", "updated_at"],
  workflow_session_snapshots: ["id", "pibo_session_id", "workflow_id", "workflow_version", "base_definition_hash", "effective_definition_hash", "snapshot_json", "created_at"],
  workflow_prompt_assets: ["asset_id", "source", "display_name", "active_revision_id", "created_at", "updated_at"],
  workflow_prompt_asset_revisions: ["revision_id", "asset_id", "content_hash", "markdown", "created_at"],
  workflow_lifecycle_events: ["id", "type", "pibo_session_id", "workflow_run_id", "validation_json", "diagnostics_json", "payload_json", "created_at"],
  workflow_identities: [
    "workflow_id",
    "source",
    "title",
