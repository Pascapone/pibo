// C1 pilot backend entry for pibo.vscode-web.
//
// Single-sourced re-export of the in-repo plugin setup: behavior stays owned by
// src/plugins/packaged-vscode-web.ts, this package only proves the K06 packaging
...
export { setupVscodeWeb as setup } from "../../../src/plugins/packaged-vscode-web.js";
