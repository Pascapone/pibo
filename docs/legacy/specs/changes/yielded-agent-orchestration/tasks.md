...
title: "Tasks: Yielded Agent Orchestration"
...
---
# Tasks: Yielded Agent Orchestration

- [x] Carry forward cancellation settlement from PR #564.
- [x] Make delegated send yielded-only and auto-enable required run control.
- [x] Remove the delegated reply lifetime default.
- [x] Add conditional management context.
- [x] Add a read-only concrete runtime resolution manifest to Build Context.
- [x] Propagate run/request provenance and add Observe filters.
