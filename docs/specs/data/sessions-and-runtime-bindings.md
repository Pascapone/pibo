...
Pibo Session records, ps_ identity creation, parent/origin fields, active model metadata, runtime binding state, revisioned CAS, and compatibility session stores.
...
- Persistence and models: PiboSession; PiboSessionStore; RuntimeSessionBinding; states unbound/bound/missing/error; sessions and session_runtime_bindings in pibo.sqlite; compatibility pibo_sessions and pibo_session_runtime_bindings.
