...
| REQ-015 Native Codex | Codex | Fixtures, exact binary, Pibo2 integrated flows | 9.1 schema through 9.11 lifecycle/resources/tools/subagents/profile pass on exact Pibo2 `0.147.0`; 9.12 consolidates 76/76 deterministic Codex/shared-contract/import-boundary checks; provider-authenticated public turns and full integrated flows remain milestone 10 |
...
| REQ-017 Verification | All | Local and Pibo2 evidence reports | Runtime foundation through Codex 9.13 has focused/full/exact evidence; consolidated Codex matrix 76/76, import boundaries 2/2, and full suite 1,734/1,734 pass; milestone-10 integrated flows and final cross-runtime audit remain |
| REQ-018 Delivery | All | Branch/commit/PR/final audit | Runtime foundation, Pi parity, and native Codex checkpoints through 9.14 are committed/pushed in the reviewable stack through PR #502; milestone-10 integrated evidence, canonical docs, and final audit remain |
