...
- [x] SC-AUTH-005: Exact candidate `cc0dcde6616dcec6a8dcf7cd0f78e70478a8ab1c` passed disconnected login readiness, authorized managed Device code authentication, safe connected status, one bounded public native-Codex production-provider turn, and cleanup on Pibo2.
