...
- `test/ralph-run-timeout.test.mjs` verifies that Ralph runs have no timeout by default, correlated session errors do not interrupt Pi retry recovery, and explicitly configured run timeouts still work.
