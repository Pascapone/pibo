  ...
  requirements:
    ...
    - id: "RUN-MUS-008"
      ...
      tests:
        ...
        - path: "test/muse-native-session.test.mjs"
          name: "Muse native recovery ignores a terminal for a natively running turn"
        - path: "test/muse-native-session.test.mjs"
      ...
      failures:
        ...
        - "Terminals for still-running turns are ignored as stale instead of killing the turn."
