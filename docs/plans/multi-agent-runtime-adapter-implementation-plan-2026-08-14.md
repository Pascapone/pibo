...
| 2026-08-15 | Codex App Server protocol checkpoint 9.1 complete | `feature/agent-runtime-codex-native` | Official Pibo2 Codex 0.147.0 pinned; exact stable TypeScript/JSON Schema generated; full/v2 schema hashes and binary evidence stored; diagnostic credential route fully cleaned and excluded | Pi parity 2.11 remains blocked until approved Pibo2-managed OpenAI authentication is provisioned; do not start 9.2 |
