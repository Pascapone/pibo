...
| AP-04/05/06/08 | Kollisionsklassifikation, Deadline-Grace und Epochen-Fencing, monotone Wakeups sowie begrenzte Receipt-/Audit-Reconciliation sind implementiert. Die exakte 476-Dateien-Abdeckung von `722883c4` schließt die damaligen Regressionen ein. Der spätere Gesamtdiff-Review fand zusätzlich eine verlorene `classificationComplete=false`-Markierung bei ausgeschöpfter Beziehungssuche; `34cb7270` behebt sie mit einer neuen Cursor-Regression. Auf dem exakten Paket von `c917b544` blieb die Klassifikation über den Cursor unbekannt, endete mit `scope_unclassified`, war read-only und ließ beide Stores bytegleich. |
...
| AP-10 | `722883c4` besitzt Build, gehashtes Paket, exakte 476/476-Dateipfadabdeckung, AP-03-Foreign-Write-Pass, den für die Servereinstellung freigegebenen geschützten 3.250-Admission-Pass, authentifizierte headful Desktop-/Mobile-/Recovery-Evidenz, echte Luna/medium-Toolarbeit, einen 6-Parent-/12-Child-Endzustand, einen 31-minütigen Modell/MCP-Workflow und einen geschützten 7.200,496-Sekunden-Soak mit 6.484 kontinuierlichen Soak-Commands. Der frühere 10.000-Admission-Schutzstopp bleibt als Ressourcengrenze dokumentiert, ist nach der ausdrücklichen Freigabe von 3.250 aber kein offenes Gate mehr. Das physische Zielgerät bleibt extern. |
...
Der neue exakte Soak lief vom 2026-09-12 22:37:25 UTC bis 2026-09-13 00:39:04 UTC. Seine gemessene Soakphase ohne Vorbereitung betrug 7.200,496 Sekunden und enthielt 6.484 reale, im Abstand von ungefähr einer Sekunde angebotene Commands. Insgesamt wurden 7.504 eindeutige Commands angenommen, verfolgt, genau einmal terminal abgeschlossen und durch 7.504 eindeutige Effekte bestätigt; 0 fehlende oder zusätzliche Effekte, 0 nichtterminale Queuezeilen, 0 Failures und 0 Incomplete-Zeilen. Admission-p95 war 15,22 ms, Status-p95 11,98 ms. Die äußere Schutzschicht endete erfolgreich ohne OOM; Spitzenwerte waren Memory-Full-PSI 1,08 und I/O-Full-PSI 4,04 bei Grenzen 5 und 10. Die neun Harness-/Produkthashes stimmen mit dem früheren exakten `722883c4`-Lauf überein; deshalb wurde die unveränderte 476-Dateien-Suite vor dem Soak nicht wiederholt.

Für die finale Parent-Prüfung wurde der saubere Source-Stand `c917b544cfe71e6d697637ca9b9b3b538b636ad3` in Docker aus 2.849 geprüften tracked Dateien paketiert. Das 4.039.035-Byte-Paket hat SHA-256 `ae1e8cb84658441168ea2bd78ba0f9454b628a1b71fa6d74a10ec5ceec992261`. Die äußere Schutzschicht stoppte den Pack-Wrapper nach bereits abgeschlossenem `npm pack` bei Memory-Full-PSI 6,14 an der unveränderten Grenze 5; es blieb kein Buildprozess zurück und kein zweiter Paketbuild wurde gestartet. Archiv, Postpack-Ausgabe, Quellmanifest und sauberer Worktree wurden separat geprüft. Pibo2-Lease `lease_142a8b738a5705212f` installierte genau Commit und Artefakthash. Der AP-08-Cursorpfad bestand über die installierte CLI; drei öffentliche `/health`-, fünf `/api/chat/status`- und eine `/status`-Action-Prüfung blieben jeweils unter 500 ms und aktivierten keine Runtime. Die Lease wurde am 2026-09-13 um 01:26:55 UTC freigegeben; der Pool meldete danach `active: 0`, `free: 10`. Volle Suite, Admission-Last, Soak, Logins, Portfolio, MCP und headful Browser wurden nicht wiederholt.[^final-pr-candidate-evidence]

Der Plan bleibt `draft`, weil das physische Zielgerät weiterhin extern ist; die 390×844-Emulation ersetzt es nicht. Der Zwei-Stunden-Soak ist geschlossen. Die erfolgreiche 3.250-Admission-Messung entspricht der ausdrücklich freigegebenen Servereinstellung; ein weiterer 10.000-Admission-Lauf wäre daher keine erforderliche Abnahme und wurde nach dem bekannten Host-I/O-Schutzstopp nicht wiederholt. Die erste explizite Pibo2-Lease `lease_0e34ee90319d825b87` wurde am 2026-09-12 um 21:24:14 UTC freigegeben. Die spätere headful Lease `lease_8b448039c94bde2e01` wurde am selben Tag um 22:19:20 UTC freigegeben; Browser-Slot `pibo-chat-slot-002` wurde ebenfalls freigegeben und sein Profil gelöscht. Die finale Pibo2-Nachprüfungslease `lease_142a8b738a5705212f` wurde am 2026-09-13 um 01:26:55 UTC freigegeben; danach meldete der Pool `active: 0`, `free: 10`.
