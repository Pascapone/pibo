...
**Plan:** Arbeitsplan V4 (`beta4-phase2/beta4-arbeitsplan-v4.md`, Anhang R) + normative Details in der [Remote-Agent-Plugin-Contract-Spec](/specs/resources/remote-agent-plugin-contract.md). Remote bleibt erhaltenes wichtiges Plugin (Trennung vom Kern als Ziel; Kopplung an `subagents/tool` + Beta-Builder dokumentiert) und ergänzt Cs Bündel; K07 bleibt ausschließlich Attachments. Konkrete Grenzen F1–F7 stehen in der Spec; B-Review (APPROVE ohne Blocker) und Controller-Befunde sind eingearbeitet.
