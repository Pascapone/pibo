...
| F06 – Minimal- und Standarddistribution bauen | abgeschlossen | Commit `8ad776f1`; ausführbarer pluginfreier Core, physische Closure, Offline-Installation aller 23 Tarballs und Candidate-Installer geprüft | lokal akzeptiert in F10 | Publish bleibt separate Aktion |
...
| F10 – Integrierte Abschlussabnahme | abgeschlossen | Kandidat `8ad776f1`; kanonische Regression, ausführbarer Offline-Core, Gateway 5/5 und aktuelle headful Desktop-/Mobile-Evidenz | lokal akzeptiert | kein Publish, Release, Deployment oder Pibo2 in diesem Lauf |
...
- N-025 geschlossen und F06/F10 erneut lokal abgeschlossen: Kandidat `8ad776f1` liefert Core/Cutover/Standard `4.0.0-beta.1` und 20 Pluginpakete `1.0.0`. Der Core-Tarball besitzt CLI, Gateway, Chat, Worker und fünf Core-Ansichten, startet offline mit Profil `core` und `pibo.runtime-unassigned`, hält Session-Pluginplan und Agent-Pluginpreview leer/diagnostisch und enthält keine Plugin-Entrypoints oder konkrete Runtime-/Featureimplementierungen in der geprüften Closure. Die kanonische Regression ergab 3.045 Tests, 3.035 Pässe, 0 Fehler und 10 Skips; nach den letzten Korrekturen bestanden 168/168 fokussierte Runtime-/Webtests, 28 Pakettests bei einem erwarteten Skip und die separat begrenzte Gatewayintegration 5/5. Headful Desktop/Mobile und CDP waren abschließend ohne Netzwerk- oder Konsolenfehler. Pibo2, reale All-Runtime-Modellabnahme, Push, PR, Deployment, Merge, Release, Publish und Controller-Gateway-Mutation bleiben ausgeschlossen.
