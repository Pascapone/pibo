...
const expectedCases=Number(process.argv[3]??18);
...
const cdpPort=Number(readFileSync(directory+'cdp-port','utf8').trim());
if(!Number.isInteger(cdpPort)||cdpPort<1024)throw new Error('Owned browser CDP port unavailable');
